...
class AdminSignup extends Component {
    ...
    onSubmit(event) {
        ...
        this.props.adminSignupRequest(this.state, history);
    }
    ...
    render() {
        return (
            <Fragment>
                <Helmet>
                    <title>ABNB FCU | Admin Signup</title>
                    <meta charSet="utf-8" />
                ...
                <main id="content" role="main">
                    <div className="container space-2">
                        <form className="js-validate w-md-75 w-lg-50 mx-md-auto">
                            <div className="mb-7">
                                <h2 className="h3 text-primary font-weight-normal mb-0">Hello <span className="font-weight-semi-bold">there</span></h2>
                                <p>Sign up to manage accounts.</p>
                            </div>
                            ...
                            <div className="row align-items-center mb-5">
                                <div className="col-6">
                                    ...
                                    <Link className="small" to='/admin/signin'>Login</Link>
                                </div>
...
export default connect(null, { adminSignupRequest })(AdminSignup);